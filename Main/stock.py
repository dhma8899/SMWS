...
def Buy():  
    ...
    for i in range(5):
        ...
        if change_factor or Purchase_Change<-5:
            
            Sell(i)
        
        elif Change<=0 and Change>-10 and Current<Money_left and (validation_time<=1430) and flag==0: 

            file1 = open("logs.txt","a")
            
            New_Purchase_Stock=0
                
            New_Purchase_Stock=1
            ...
            print("Bought 1 "+sheet_obj['A'+str(i+2)].value+" Stock at "+str(Current)+" and current balance:"+str(Money_left))
